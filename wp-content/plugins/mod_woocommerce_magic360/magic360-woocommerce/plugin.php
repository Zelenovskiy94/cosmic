...
function WooCommerce_Magic360_send_stat($action = '') {
    ...
    if('working' == 'v6.8.50' || 'working' == 'v4.6.12') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magic360&license=trial&tool_version=v4.6.12&module_version=v6.8.50&platform_name=woocommerce&platform_version={$platformVersion}&url={$url}";
...
function WooCommerce_Magic360_export() {
    ...
    WooCommerce_Magic360_wp_export(get_option("WooCommerceMagic360CoreSettings"), $secret_data, $value);
    exit;
}
